...
parquet_bestand = '/home/azureuser/mads-exam-fharren/runs/20250624-172550_all_model_summary.parquet'

# Laad het Parquet-bestand
df = pd.read_parquet(parquet_bestand)

# Sla het op als CSV-bestand
csv_bestand = '/home/azureuser/mads-exam-fharren/runs/20250624-172550_all_model_summary.csv'
